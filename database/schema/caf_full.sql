-- CAF Data Model — full consolidated schema (run in MySQL Workbench)
CREATE DATABASE IF NOT EXISTS facilon_fpi_vapt CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
